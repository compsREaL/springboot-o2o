$(function () {
    ...
    function getList() {
        $.getJSON(listUrl,function (data) {
            if (data.success){
                ...
                var tempHtml = "";
                shopAuthMapList.map(function (item, index) {
                    var textOp = "恢复";
                    ...
                    tempHtml += "<div class='row row-shopauth'>" + "<div class='col-40'>"+ item.employee.name+"</div> ";
                    ...
                    if (item.titleFlag!=0){
                        ...
                        tempHtml+= "<div class='col-20'>"+item.title+"</div>"+"<div class='col-40'>"
                            ...
                            + item.shopAuthId + "'>编辑</a> "+"<a href='#' class='status' data-auth-id='"+item.shopAuthId
    ...
    /**
     * 给a标签的click事件绑定上对应的方法
     * 点击带有edit的a标签就会跳转到授权编辑页面
     * 点击带有status的a标签就会去更新授权信息状态
     */
